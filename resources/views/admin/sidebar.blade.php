...
<aside class="app-sidebar">
    <div class="app-sidebar__user">
        <div>
            <p class="app-sidebar__user-name">managment site</p>
    ...
    <ul class="app-menu">
        ...
        <li>
        <a class="treeview-item" href="#"><i class="icon fa fa-circle-o"></i>Add products</a>
        </li>
        <li>
            <a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-cogs"></i>
                <span class="app-menu__label">Add category</span>
            </a>
        </li>
    </ul>
</aside>